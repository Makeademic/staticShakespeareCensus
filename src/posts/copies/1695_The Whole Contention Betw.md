...
local_notes: ["Whole Contention only. cs0900(2). Imperfect: lacking all after Q4 (parts 1 and 2 only). Burn hole on F3. Q1 torn, affecting text."]
height: ["0"]
width: ["0"]
marginalia: null
condition: ["\N"]
...
Whole Contention only. cs0900(2). Imperfect: lacking all after Q4 (parts 1 and 2 only). Burn hole on F3. Q1 torn, affecting text.
