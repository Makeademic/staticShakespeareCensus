...
local_notes: ["Title page supplied from Wing S2917 issue, unclear if originally with this copy"]
height: ["0"]
width: ["0"]
marginalia: null
condition: ["\N"]
...
Title page supplied from Wing S2917 issue, unclear if originally with this copy
