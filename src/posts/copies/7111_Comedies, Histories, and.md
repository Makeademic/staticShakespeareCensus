...
shelfmark: ["Berg Coll. +Shakespeare 1664"]
location_verified: ["t"]
...
local_notes: ["Includes: 1664 title leaf, 1664 "verses" leaf, and the additional plays. Jonson's "verses" and portrait laid down, possibly from another copy."]
height: ["0"]
width: ["0"]
marginalia: null
condition: ["\N"]
binding: ["Bound in green morocco"]
binder: ["\N"]
bookplate: ["\N"]
...
Lee_notes: null
prov_info: ["Signature of John Lawler(?) on blank recto of frontis"]
bibliography: null
created_by_id: ["\N"]
apocryphal: ["f"]
hidden: ["f"]
...
Includes: 1664 title leaf, 1664 "verses" leaf, and the additional plays. Jonson's "verses" and portrait laid down, possibly from another copy.
...
Signature of John Lawler(?) on blank recto of frontis
