...
local_notes: ["Whole Contention only. cs136. Imperfect: lacking sigs.A-B, and all after Q4."]
height: ["0"]
width: ["0"]
marginalia: null
condition: ["\N"]
binding: ["Half black goatskin"]
binder: ["\N"]
bookplate: ["\N"]
...
Lee_notes: null
prov_info: ["MS. letter signed "J. O. Halliwell [Phillipps]" is tipped to front end-paper."]
bibliography: null
created_by_id: ["1"]
apocryphal: ["f"]
hidden: ["f"]
...
Whole Contention only. cs136. Imperfect: lacking sigs.A-B, and all after Q4.
...
MS. letter signed "J. O. Halliwell [Phillipps]" is tipped to front end-paper.
